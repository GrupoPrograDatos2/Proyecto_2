...
Gladiador::Gladiador(string nombre, int GMano, int GPies, int GCuerpo,int RMano, int RPies, int RCuerpo)
{
    indice_de_mutacion=(int) rand()%5 + 1;
    	indice_inversion=(int) rand()% 3 + 1;
        Nombre=nombre;
